...
# 準備測試資料
test_ids = original_test_df['Id']
if 'Id' in test_df.columns:
    X_submission = test_df.drop('Id', axis=1)
else:
    X_submission = test_df.copy()
X_submission = X_submission[X.columns] # 確保欄位順序一致
...
model_path = SAVED_MODELS_DIR / 'xgboost_best_model.pkl'
config_path = SAVED_MODELS_DIR / 'xgboost_best_config.json'
...
submission_filename = SUBMISSIONS_DIR / 'submission_xgb_optuna.csv'
